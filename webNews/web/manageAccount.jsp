<%-- 
    Document   : admin2
    Created on : Jul 9, 2023, 10:10:04 PM
    Author     : kiemq
--%>
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="accountmanagement" class="active">Account List</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="page-wrapper">
                <div class="content">
                    <div class="page-header">
                        ...
                        <div class="page-btn">
                            <a href="AddNewAccount" class="btn btn-added"><img src="adminassets/img/icons/plus.svg" alt="img"
                                                                                 class="me-1">Add New Account</a>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <c:forEach var="o" items="${listU}">
                                            <tr>
                                                ...
                                                <td>${o.fullname}</td>    
                                                <td>
                                                    <a class="me-3" href="UpdateAccount?id=${o.id}">
