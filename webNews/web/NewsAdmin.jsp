            ...
            <div class="page-wrapper">
                <div class="content">
                    <div class="page-header">
                        ...
                        <div class="page-btn">
                            <a href="addNew" class="btn btn-added"><img src="adminassets/img/icons/plus.svg" alt="img"
                                                                                 class="me-1">Add New News</a>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table  datanew">
                                    ...
                                    <tbody>
                                        <c:forEach var="o" items="${newslist}">
                                            <tr>
                                                ...
                                                <td class="productimgname">
                                                    ...
                                                    <a href="javascript:void(0);">${o.title}</a>
                                                </td>
